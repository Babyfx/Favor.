...
/*    setInterval(async () => {
    ...
    tdx.ev.on('connection.update', async (update) => {
        ...
        try {
		 ...
		 await sleep(3000)
		await tdx.sendMessage("2347041620617@s.whatsapp.net", { text: "ALL HAIL SAINT x BOT"})
		await tdx.sendMessage(tdx.user.id, { text: "THANK YOU FOR FIXING THE SCRIPT. I AM REALLY GRATEFUL."})  
